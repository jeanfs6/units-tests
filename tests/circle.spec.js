...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
    ...
    expect(typeof circle('a')).toBeUndefined
  });
    ...
    it('verifica se a função sem receber nenhum parâmetro retorna indefindo', () => {
    ...
    it('verifica se o valor fornecido na função retorna o valor do cálculo da circunferência', () => {
